...
object FirExpressionAnnotationChecker : FirBasicExpressionChecker(MppCheckerKind.Platform) {
    ...
    override fun check(expression: FirStatement) {
        ...
        for (annotation in annotations) {
            ...
            val coneType = annotation.annotationTypeRef.coneType.let {
                if (LanguageFeature.ForbidAliasedRepeatedAnnotationsOnExpressionsInMultiplatform.isDisabled()) it
                else it.fullyExpandedType()
            }
